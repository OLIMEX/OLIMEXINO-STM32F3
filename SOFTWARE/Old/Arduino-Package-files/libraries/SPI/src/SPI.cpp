...
// Additional instances of SPI
#if ((defined PIN_SPI2_MOSI) && (defined PIN_SPI2_MISO) && (defined PIN_SPI2_SCK) && (defined PIN_SPI2_SS))
SPIClass SPI_2 (PIN_SPI2_MOSI, PIN_SPI2_MISO, PIN_SPI2_SCK, PIN_SPI2_SS);
#endif

#if ((defined PIN_SPI3_MOSI) && (defined PIN_SPI3_MISO) && (defined PIN_SPI3_SCK) && (defined PIN_SPI3_SS))
SPIClass SPI_3 (PIN_SPI3_MOSI, PIN_SPI3_MISO, PIN_SPI3_SCK, PIN_SPI3_SS);
#endif
